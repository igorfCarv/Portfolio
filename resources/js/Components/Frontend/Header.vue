    ...
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="w-full md:block md:w-auto" id="navbar-default" :class="{ hidden: showMobileMenu }">
                <ul
                    class="flex flex-col p-4 mt-4 rounded-lg  border border-light-tail-500 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:dark:bg-gray-900 dark:border-dark-navy-100">
                    <li>
                        <a href="#"
                            class="block py-2 pr-4 pl-3 text-white bg-light-tail-500 dark:bg-dark-navy-100 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
